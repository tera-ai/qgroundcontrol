...
elseif(IOS)
    ...
    set_target_properties(${CMAKE_PROJECT_NAME}
        PROPERTIES
            ...
            # PRODUCT_NAME is the on-disk bundle name (TGroundControl.app on
            # iOS) and the executable inside it. Must match OUTPUT_NAME.
            XCODE_ATTRIBUTE_PRODUCT_NAME "${QGC_APP_NAME}"
            ...
            XCODE_ATTRIBUTE_INFOPLIST_KEY_CFBundleDisplayName "${QGC_APP_NAME}"
