...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(buttonHighlight,      "#e4e4e4", "#3A9BDC", "#3a3a3a", "#3DA876")
    DECLARE_QGC_COLOR(buttonHighlightText,  "#2c2c2c", "#ffffff", "#2c2c2c", "#ffffff")
    DECLARE_QGC_COLOR(primaryButton,        "#585858", "#8cb3be", "#585858", "#6BF6A7")
    ...
    DECLARE_QGC_COLOR(mapButtonHighlight,   "#585858", "#3DA876", "#585858", "#6BF6A7")
    ...
    //                                                      Disabled     Enabled
    DECLARE_QGC_NONTHEMED_COLOR(brandingPurple,             "#6BF6A7", "#6BF6A7")
    DECLARE_QGC_NONTHEMED_COLOR(brandingBlue,               "#63DED2", "#63DED2")
